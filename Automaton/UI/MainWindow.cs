...
//                                if (feature.IsDebug && !Config.ShowDebug) continue;
...
//                                DrawFeatures(P.Features.Where(x => x.FeatureType == FeatureType.Actions && (!x.IsDebug || Config.ShowDebug)).ToArray());
//                                break;
//                            case OpenWindow.UI:
//                                DrawFeatures(P.Features.Where(x => x.FeatureType == FeatureType.UI && (!x.IsDebug || Config.ShowDebug)).ToArray());
//                                break;
//                            case OpenWindow.Other:
//                                DrawFeatures(P.Features.Where(x => x.FeatureType == FeatureType.Other && (!x.IsDebug || Config.ShowDebug)).ToArray());
//                                break;
//                            case OpenWindow.Targets:
//                                DrawFeatures(P.Features.Where(x => x.FeatureType == FeatureType.Targeting && (!x.IsDebug || Config.ShowDebug)).ToArray());
//                                break;
//                            case OpenWindow.Chat:
//                                DrawFeatures(P.Features.Where(x => x.FeatureType == FeatureType.ChatFeature && (!x.IsDebug || Config.ShowDebug)).ToArray());
//                                break;
//                            case OpenWindow.Achievements:
//                                DrawFeatures(P.Features.Where(x => x.FeatureType == FeatureType.Achievements && (!x.IsDebug || Config.ShowDebug)).ToArray());
//                                break;
//                            case OpenWindow.Commands:
//                                DrawCommands(P.Features.Where(x => x.FeatureType == FeatureType.Commands && (!x.IsDebug || Config.ShowDebug)).ToArray());
//                                break;
...
//                        if (feature.Enabled)
//                        {
//                            Config.EnabledTweaks.Add(feature.GetType().Name);
//                        }
//                    }
//                    catch (Exception ex)
//                    {
...
//                    {
//                        feature.Disable();
//                        Config.EnabledTweaks.Remove(feature.GetType().Name);
