...
[Tweak(outdated: true)]
public unsafe class WorkshopTurnin : Tweak
{
    public override string Name => "FC Workshop Hand-In";
    public override string Description => "This functionality has been replicated in Workshoppa. Please migrate to that instead.";

    public override void DrawConfig()
    {
        ImGuiX.DrawLink("Liza's Repo", "Liza's Repo", "https://plugins.carvel.li");
    }
    ...
    //{
    //    EzConfigGui.WindowSystem.RemoveWindow(overlay);
    //    Svc.Framework.Update -= Tick;
    //    base.Disable();
    //}
    ...
    //internal static string[] PanelName = ["Fabrication Station"];
    //internal static bool TryGetNearestFabricationPanel(out DGameObject obj) =>
