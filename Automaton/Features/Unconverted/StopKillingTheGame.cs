...
public unsafe class NoKill : Feature
{
    ...
    {
        var a1_88 = (ushort)Marshal.ReadInt16(new nint(a1 + 88));
        var a1_456 = Marshal.ReadInt32(new nint(a1 + 456));
        Svc.Log.Debug($"Start a1_456:{a1_456}");
        if (a1_456 != 0 && Config.QueueMode)
        {
            Marshal.WriteInt32(new nint(a1 + 456), 0);
    ...
    {
        var a1_2165 = Marshal.ReadByte(new nint(a1 + 2165));
        Svc.Log.Debug($"Login a1_2165:{a1_2165}");
        if (a1_2165 != 0 && Config.QueueMode)
        {
            Marshal.WriteByte(new nint(a1 + 2165), 0);
    ...
    private void CheckDialogue(IFramework framework)
    {
        ...
        if (Svc.GameGui.GetAddonByName("Dialogue") != nint.Zero && !Svc.Condition.Any())
        {
